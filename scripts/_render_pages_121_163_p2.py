# Part 2: pages 129-163 (exec'd from _render_pages_121_163.py)

page_open(129, "304~305", compact=True)
q("304.", "전원장치인 UPS, CVCF, VVVF 장치에 대한 비교표를 다음과 같이 구성할 때 빈칸을 채우시오. 단, 출력전원에 대하여 가능은 ○, 불가능은 ×로 표시하시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("305.", "전류형 인버터와 전압형 인버터의 회로상의 차이점을 2가지씩 쓰시오.",
  '      <table class="tbl">',
...
page_open(130, "306~307", day_tag="단답비급 DAY 11")
q("306.", "전류형 인버터와 전압형 인버터의 출력 파형 상의 차이점을 설명하시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("307.", "사용 중인 UPS의 2차측에 단락사고 등이 발생했을 경우 UPS와 고장회로를 분리하는 방식 3가지를 쓰시오.",
...
page_close(130, "brand-l")

page_open(131, "308~310", sec="고장 및 사고", compact=True, top="top:108px;")
q("308.", "일반용 전기설비 및 자가용 전기설비에 있어서 과전류(과부하)의 종류 2가지와 각각에 대한 용어의 정의를 쓰시오.",
...
q("309.", "인체가 전기설비에 접촉되어 감전 재해가 발생하였을 때 감전 피해의 위험도를 결정하는 요인 4가지를 쓰시오.",
...
q("310.", "다음은 인체에 전류가 흘러 감전된 정도를 설명한 것이다. ( ) 안에 알맞은 용어를 쓰시오.",
...
page_open(132, "311~317", day_tag="단답비급 DAY 11", compact=True)
q("311.", "전기화재 발생원인 5가지를 쓰시오.",
...
q("312.", "케이블의 트리현상이란 무엇인가 쓰고 종류 3가지를 쓰시오.",
...
q("313.", "변압기, 발전기, 모선 또는 이를 지지하는 애자는 어느 전류에 의하여 생기는 기계적 충격에 견디는 강도를 가져야 하는가?",
  '      <p class="ans-line"><span class="ans">단락전류</span></p>')
q("314.", "단락전류를 계산하는 것은 주로 어떤 요소에 적용하고자 하는 것인지 그 적용 요소에 대하여 3가지만 설명하시오.",
  '      <p class="ans-line">① <span class="ans">차단기의 차단용량 결정</span> &nbsp; ② <span class="ans">보호 계전기의 정정</span> &nbsp; ③ <span class="ans">기기에 가해지는 전자력의 추정</span></p>')
q("315.", "다음과 같은 사고종류에 대한 보호장치 및 보호조치를 작성하시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("316.", "1선 지락 고장 시 접지계통별 고장전류의 경로를 답란에 쓰시오.",
  '      <table class="tbl">',
...
page_open(136, "318~320", sec="접지", compact=True, top="top:108px;")
q("318.", "접지공사의 목적을 3가지만 쓰시오.",
...
q("319.", "변압기 중성점 접지(계통접지)의 목적 3가지만 쓰시오.",
...
q("320.", "아래 그림과 같이 시행한 계통접지와 기기접지의 기능을 설명하시오.",
  '      <table class="tbl">',
...
page_open(137, "321~324", day_tag="단답비급 DAY 12", compact=True)
q("321.", "접지저항의 결정요인인 접지저항 요소 3가지를 쓰시오.",
...
q("322.", "접지공사에서 접지저항을 저감시키는 방법을 5가지만 쓰시오.",
  '      <p><b>[물리적 방법]</b></p>',
...
q("323.", "대지 저항률을 낮추기 위한 저감재의 구비조건 4가지를 쓰시오.",
...
q("324.", "중성점 접지 저항기의 기능을 쓰시오.",
  '      <p class="ans-line"><span class="ans">지락사고 시 지락전류 억제 및 건전상 대지전위 상승 억제</span></p>')
page_close(137, "brand-l")

page_open(138, "325~326")
q("325.", "배전용 변전소의 접지 공사를 하고자 한다. 주요한 접지 개소를 5가지만 쓰시오.",
...
q("326.", "중성점 직접 접지계통에 인접한 통신선의 전자유도 장해 경감에 관한 대책을 경제성이 높은 것부터 설명하시오.",
...
page_open(139, "327~328", day_tag="단답비급 DAY 12", compact=True)
q("327.", "비접지 3상 3선식 배전방식과 비교하여, 3상 4선식 다중접지(직접접지) 배전방식의 장점 및 단점을 각각 4가지씩 쓰시오.",
  '      <p><b>[장점]</b></p>',
...
q("328.", "독립접지와 비교하여 공통접지의 장점과 단점을 각각 3가지만 쓰시오.",
  '      <p><b>1. 공통접지의 장점</b></p>',
...
page_close(139, "brand-l")

page_open(140, "329")
q("329.", "그림을 보고 다음 각 물음에 답하시오.",
...
page_open(141, "330~332", day_tag="단답비급 DAY 12", compact=True)
q("330.", "피뢰기의 접지저항 값은 몇 [Ω] 이하로 하여야 하는가?",
  '      <p class="ans-line"><span class="ans">10[Ω]</span></p>')
q("331.", "다음 그림에서 ①~⑤까지의 명칭을 쓰시오.",
  "      <!--IMG:p140_diag331-->",
  '      <table class="tbl">',
  ...
  "      </table>")
q("332.", "① ~ ③에 알맞은 보호도체의 최소 단면적의 기준을 각각 쓰시오.",
  '      <table class="tbl">',
...
q("335.", "주 접지 단자에 접속하기 위한 보호본딩도체의 단면적은 구리도체 ( ) [mm²] 또는 다른 재질의 동등한 단면적을 초과할 필요는 없다.",
  '      <p class="ans-line">( <span class="ans">25</span> ) [mm²]</p>')
page_close(142)

memo(143)

page_open(144, "336~339", day_tag="단답비급 DAY 12", sec="절연", compact=True, top="top:108px;")
q("336.", "고압 및 특고압 전로의 절연내력 시험 방법에 대해 설명하시오.",
  '      <p class="ans-line"><span class="ans">시험전압을 충전부(전로)와 대지 사이에 연속하여 10분간 가하여 절연내력을 시험하였을 때 이에 견디어야 한다.</span></p>')
q("337.", "아래 표의 ( )에 알맞은 값을 쓰시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("338.", "전기사용 장소의 사용전압이 저압인 전로의 절연저항은 다음 표에서 정한 값 이상이어야 한다. 빈칸에 절연저항 값을 써넣으시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("339.", "전로의 사용전압이 350[V] 이상 400[V] 미만인 경우 절연저항 값은 몇 [MΩ] 이상이어야 하는가?",
  '      <p class="ans-line"><span class="ans">1[MΩ]</span> 이상</p>')
page_close(144, "brand-l")

day(145, 13, "측정<br>시퀀스")

page_open(146, "340~343", sec="측정", compact=True, top="top:108px;")
q("340.", "지중 배전선로에서 사용하는 전력케이블의 고장점 측정을 위해 사용되는 방법을 3가지만 쓰시오.",
  '      <p class="ans-line">① <span class="ans">머레이루프법</span> &nbsp; ② <span class="ans">펄스레이더법</span> &nbsp; ③ <span class="ans">정전용량법</span></p>')
q("341.", "지중 케이블의 고장점 탐지법 3가지와 각각의 사용 용도를 쓰시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("342.", "다음과 같은 저항을 측정하는 방법이나 측정계기를 쓰시오.",
...
q("343.", "접지저항을 측정하기 위하여 사용되는 측정방법 2가지를 쓰시오.",
...
page_open(147, "344~345", day_tag="단답비급 DAY 13", compact=True)
q("344.", "다음은 지중케이블의 사고점 측정법과 절연의 건전도를 측정하는 방법을 열거한 것이다. 다음 방법들을 구분하여 답하시오.",
  '      <p class="ans-line">1. 사고점 측정법 : <span class="ans">④, ⑤, ⑥</span></p>',
  '      <p class="ans-line">2. 절연 열화 측정법 : <span class="ans">①, ②, ③</span></p>')
q("345.", "그림은 전위 강하법에 의한 접지저항 측정방법이다. E, P, C가 일직선상에 있을 때, 다음 물음에 답하시오. (단, E는 반지름 r인 반구모양 전극이다.)",
...
page_close(147, "brand-l")

page_open(148, "346~348")
q("346.", "4개의 측정탐침(4-Test Probe)을 지표면에 일직선 상에 등거리로 박아서 측정장비 내에서 저주파 전류를 탐침을 통해 대지에 흘려 보내어 대지저항률을 측정하는 방법을 무엇이라 하는가?",
  '      <p class="ans-line"><span class="ans">웨너 4전극법</span></p>')
q("347.", "Wenner의 4전극법에 대한 공식을 쓰고, 원리도를 그려 설명하시오.",
  "      <!--IMG:p147_wenner-->",
  r'      <p class="formula">$\rho = 2\pi a R$ (단, $a$ : 전극간격 [m], $R$ : 접지저항 [Ω])</p>',
...
q("348.", "수전용 차단기와 과전류계전기 연동시험 시 시험전류를 가하기 전에 점검하여야 할 사항을 3가지만 쓰시오.",
...
page_open(149, "349~350", day_tag="단답비급 DAY 13", compact=True)
q("349.", "과전류계전기와 수전용 차단기 연동시험 시 시험전류를 가하기 전에 준비하여야 하는 기기 3가지를 쓰시오.",
  '      <p class="ans-line">① <span class="ans">물저항기</span> &nbsp; ② <span class="ans">전류계</span> &nbsp; ③ <span class="ans">사이클 카운터</span></p>')
q("350.", "다음 그림은 전자식 접지 저항계를 사용하여 접지극의 접지저항을 측정하기 위한 배치도이다. 물음에 답하시오.",
...
page_close(149, "brand-l")

page_open(150, "351~353", sec="시퀀스")
q("351.", "THR의 명칭과 역할을 간단히 설명하시오.",
...
q("353.", "<!--IMG:p149_timed_contact--> 의 접점 명칭을 쓰시오.",
  '      <p class="ans-line"><span class="ans">한시동작 순시복귀 a접점</span></p>')
page_close(150)

page_open(151, "355")
q("355.", "릴레이 시퀀스와 무접점 시퀀스에 사용되는 전자릴레이와 무접점 릴레이를 비교할 때 전자릴레이의 장·단점을 5가지씩만 쓰시오.",
  '      <p><b>[장점]</b></p>',
...
memo(152)
day(153, 14, "정의 및 용어·규정<br>옥내 기구 기호")

page_open(154, "354", day_tag="단답비급 DAY 14")
q("354.", "그림은 타이머 내부 결선도이다. *표의 점선 부분에 대한 접점의 동작을 설명하시오.",
  "      <!--IMG:p153_relay8-->",
...
page_close(154, "brand-l")

page_open(155, "356~357", sec="정의 및 용어 · 규정", compact=True, top="top:108px;")
q("356.", "다음 주어진 전기 용어를 간단히 설명하시오.",
...
q("357.", "L1상, L2상, L3상, N상, 보호도체 ( )안에 알맞은 색을 쓰시오. (단, 상별 색이 1가지 이상인 경우 해당 색을 모두 쓰시오.)",
  '      <table class="tbl">',
...
page_open(156, "358~359")
q("358.", "한국전기설비규정에 따라 과전류차단기를 시설하지 않아도 되는 개소 3가지를 쓰시오.",
...
q("359.", "한국전기설비규정에서 규정하는 용어의 정의를 쓰시오.",
...
page_open(157, "360~361", day_tag="단답비급 DAY 14", compact=True)
q("360.", "접지도체, 보호접지, 접지시스템 중 다음 설명에 알맞게 빈칸에 작성하시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("361.", "한국전기설비규정 KEC에 따른 과전류 보호에 대한 설명으로 알맞은 내용을 쓰시오.",
...
page_close(157, "brand-l")

page_open(158, "362~364", compact=True)
q("362.", "한국전기설비규정에 의거하여 저압전로에 사용하는 주택용 배선차단기의 과전류 트립동작시간 및 순시트립에 따른 구분을 나타낸 표이다. 표에 알맞은 말을 쓰시오.",
  '      <table class="tbl">',
  ...
  "      </table>")
q("363.", "고압용의 개폐기, 차단기, 피뢰기 기타 이와 유사한 기구로서 동작 시에 아크가 생기는 것은 목재의 벽 또는 천장 기타의 가연성 물체로부터 몇 [m] 이상 떼어 놓아야 하는가?",
  '      <p class="ans-line"><span class="ans">1[m]</span></p>')
q("364.", "다음 빈칸에 알맞은 내용을 쓰시오.",
  '      <div class="box">',
...
page_open(159, "365~366", day_tag="단답비급 DAY 14", sec="옥내 기구 기호", compact=True, top="top:108px;")
q("365.", "[참고] 점멸기의 그림기호 : <!--IMG:p158_sym_sw-->",
...
page_open(160, "367~369", compact=True)
q("367.", "옥내배선 콘센트 기호",
...
q("368.", "개폐기 중에서 다음 기호(심벌)가 의미하는 것은 무엇인지 모두 쓰시오.",
  "      <!--IMG:p159_switch_sym-->",
...
q("371.", "다음과 같은 소형 변압기 심벌의 명칭을 쓰시오.",
  "      <!--IMG:p161_tr_syms-->",
...
page_close(161, "brand-l")

memo(162)

page_open(163, "372~374", sec="부록) 감리", compact=True, top="top:108px;")
q("372.", "공사시방서란 무엇인지 설명하시오.",
...
q("373.", "시운전 완료 후 발주자에게 인계하여야 할 사항(서류 등)을 5가지만 쓰시오.",
...
q("374.", "안전관리 결과 보고서에 포함되어야 하는 서류 5가지를 쓰시오.",
