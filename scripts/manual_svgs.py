...
def svg_p029_tbl054() -> str:
    return f"""<table class="tbl manual-table" style="{TABLE_STYLE}">
<thead>
<tr><th style="{TH}" rowspan="3">공사 종류</th>
...
<th style="{TH}" rowspan="2">우선 내</th><th style="{TH}" rowspan="2">우선 외</th></tr>
<tr><th style="{TH}">건조</th><th style="{TH}">습기</th><th style="{TH}" colspan="2">점검 가능</th>
<th style="{TH}" colspan="2">점검 불가</th></tr>
<tr><th style="{TH}"></th><th style="{TH}"></th><th style="{TH}"></th>
<th style="{TH}">건조</th><th style="{TH}">습기</th><th style="{TH}">건조</th><th style="{TH}">습기</th>
<th style="{TH}"></th><th style="{TH}"></th></tr>
</thead>
<tbody>
