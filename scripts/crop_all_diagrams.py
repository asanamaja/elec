...
SPECS: dict[int, list[tuple[str, fitz.Rect]]] = {
    ...
    157: [
        ("p158_sym_sw.png", fitz.Rect(254, 176, 272, 194)),
        ("p158_sym_2p.png", fitz.Rect(118, 226, 162, 250)),
        ("p158_sym_4w.png", fitz.Rect(196, 224, 238, 246)),
        ("p158_sym_outdoor.png", fitz.Rect(98, 392, 128, 416)),
        ("p158_sym_h400.png", fitz.Rect(105, 432, 126, 456)),
        ("p158_sym_m400.png", fitz.Rect(105, 462, 126, 486)),
        ("p158_sym_n400.png", fitz.Rect(105, 492, 126, 516)),
        ("p158_sym_outlet.png", fitz.Rect(228, 526, 256, 550)),
        ("p158_sym_ceiling.png", fitz.Rect(348, 550, 374, 576)),
        ("p158_sym_floor.png", fitz.Rect(346, 578, 374, 606)),
        ("p158_sym_2gang.png", fitz.Rect(88, 632, 132, 656)),
        ("p158_sym_3p_out.png", fitz.Rect(208, 510, 258, 538)),
    ],
    # 부록 표
    169: [("p170_table385.png", fitz.Rect(52, 248, 548, 398))],
    170: [("p171_table387.png", fitz.Rect(52, 168, 548, 468))],
    # p.159 Q367-369
    158: [
